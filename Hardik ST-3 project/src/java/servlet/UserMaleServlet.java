...
public class UserMaleServlet extends HttpServlet {
		...
		try
		{
			...
			ArrayList<User> list = (ArrayList<User>)dao.getMaleUsers();
			//attach the value to the request
			request.setAttribute("listUsers",list);				
			RequestDispatcher dispatch = request.getRequestDispatcher("MembersMale.jsp");
