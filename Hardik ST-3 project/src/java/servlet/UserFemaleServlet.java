...
public class UserFemaleServlet extends HttpServlet {
        ...
        public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		try
		{
			...
			ArrayList<User> list = (ArrayList<User>)dao.getFemaleUsers();
			//attach the value to the request
			request.setAttribute("listUsers",list);				
			RequestDispatcher dispatch = request.getRequestDispatcher("MembersFemale.jsp");
